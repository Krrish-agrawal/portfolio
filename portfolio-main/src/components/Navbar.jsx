    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        <li className={`${
              ...
              onClick={() => setActive(navLinks[3].title)}><a href="https://drive.google.com/file/d/1UTG1wtPjpDRdutBCIMap8Dvu6BukDsim/view?usp=drive_link" target="_blank">Resume</a></li>
        </ul>
